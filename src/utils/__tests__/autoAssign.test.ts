...
describe('buildIncrementalAutoAssignments', () => {
  ...
  it('creates assignments for unassigned students', () => {
    const data = makeSessionData()
    const result = buildIncrementalAutoAssignments(data, slots)
  ...
  it('respects student availability', () => {
    const data = makeSessionData({
  ...
  it('respects incompatible constraints', () => {
    const data = makeSessionData({
      teachers: [makeTeacher()],
  ...
  it('cleans up assignments for deleted teachers', () => {
    const data = makeSessionData({
  ...
  it('removes students when they become unavailable', () => {
    const data = makeSessionData({
      assignments: {
  ...
  it('handles empty session (no students)', () => {
  ...
  it('respects desk count limit', () => {
    ...
    const result = buildIncrementalAutoAssignments(data, ['2026-07-21_1'])
    const slot1 = result.assignments['2026-07-21_1'] ?? []
